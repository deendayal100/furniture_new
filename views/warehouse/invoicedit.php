...
<section id="extended">
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <h5 style="text-align: center;font-size: 25px;"><b>Invoice No : <span style="color:red">#<?php echo $view->orderno; ?></span></b></h5>
                <div class="card-body">
                                ...
                                <div class="col-md-12"  style="float:left">
                                  ...
                                  <div class="row">
                                        ...
                                        <select  class="form-control" name="remark" id="msglist">
                                          <option value="">--Select--</option>      
                                          <option value="Your order will be scheduled for delivery soon. TFP ">1)Your order will be scheduled for delivery soon . TFP </option>  
